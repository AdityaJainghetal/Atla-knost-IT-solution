...
//             className="fixed bottom-24 right-8 z-[100] w-full max-w-[380px] bg-gray-950 border border-red-900/50 rounded-3xl shadow-2xl overflow-hidden"
//           >
//             {/* Header */}
...
//                   <p className="text-xs text-red-100">Online • Atla Knots IT</p>
//                 </div>
//               </div>
//               <button
...
//             <div
//               ref={chatRef}
//               className="h-96 overflow-y-auto p-4 space-y-4 bg-black/60"
//             >
...
//       {/* Floating Chat Button - Positioned to the left of Scroll button */}
//       <button
//         onClick={() => setIsOpen(!isOpen)}
