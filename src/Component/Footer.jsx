...
//   src={ATLAknots}
//   alt="ATLAKnots Logo"
//   className="h-12 w-[200px] md:h-16 md:w-[260px] lg:h-20 lg:w-[320px]"
// />
    ...
    <footer className="bg-gradient-to-b from-black to-zinc-950 border-t border-red-900/30 text-gray-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-6 mt-8">
              <SocialLink href="https://www.facebook.com" icon={<Facebook size={22} />} label="Facebook" />
      ...
      <div className="border-t border-red-900/20 py-6 text-center text-xs text-gray-500">
        <div className="max-w-7xl mx-auto px-5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-wrap gap-6 justify-center">
            <Link to="/privacypolicy" onClick={(e) => handleFooterLink(e, "/privacypolicy")}>
              Privacy Policy
            </Link>
            <Link to="/termsofservice" onClick={(e) => handleFooterLink(e, "/termsofservice")}>
              Terms of Service
            </Link>
            <Link to="/cookiepolicy" onClick={(e) => handleFooterLink(e, "/cookiepolicy")}>
              Cookie Policy
            </Link>
          </div>
        </div>
