...
// export default function Navbar({ isColorSwapMode, toggleColorSwapMode }) {
//   const [isOpen, setIsOpen] = useState(false);
//   const [openDropdown, setOpenDropdown] = useState(null);
//   const [openSubDropdown, setOpenSubDropdown] = useState(null);
...
//             {/* Color Swap Toggle Button with Icon */}
//             <button
//               onClick={toggleColorSwapMode}
//               className="flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-600 hover:border-blue-400 text-gray-200 hover:text-blue-400 transition-all duration-200"
//               aria-label="Toggle color mode"
//             >
//               {isColorSwapMode ? (
//                 <>
//                   <MdWbSunny size={20} className="text-yellow-400" />
//                   <span className="text-sm font-medium">Light Mode</span>
//                 </>
//               ) : (
//                 <>
//                   <MdNightlight size={20} className="text-blue-400" />
...
//                 {/* First Level Dropdown */}
//                 {item.hasDropdown && (
//                   <div className="absolute left-0 top-full pt-2 w-56 bg-black/95 border border-gray-700 rounded-lg shadow-xl opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto transition-all duration-200 ease-out">
//                     {item.dropdownItems.map((sub) => (
//                       <div key={sub.name} className="relative group/sub">
//                         <NavLink
//                           to={sub.path}
...
//                         {/* Second Level Dropdown */}
//                         {sub.hasDropdown && (
//                           <div className="absolute left-full top-0 ml-1 w-52 bg-black/95 border border-gray-700 rounded-lg shadow-xl opacity-0 scale-95 pointer-events-none group-hover/sub:opacity-100 group-hover/sub:scale-100 group-hover/sub:pointer-events-auto transition-all duration-200 ease-out">
//                             {sub.dropdownItems.map((child) => (
//                               <NavLink
//                                 key={child.path}
//                                 to={child.path}
...
//             {/* Mobile Color Toggle with Icon */}
//             <button
//               onClick={toggleColorSwapMode}
//               className="p-2 rounded-lg border border-gray-600 hover:border-blue-400 text-gray-200 hover:text-blue-400 transition-colors"
//               aria-label="Toggle color mode"
//             >
//               {isColorSwapMode ? (
//                 <MdWbSunny size={24} className="text-yellow-400" />
//               ) : (
//                 <MdNightlight size={24} className="text-blue-400" />
//               )}
//             </button>
