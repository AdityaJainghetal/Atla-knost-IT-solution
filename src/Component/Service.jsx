...
// ────────────────────────────────────────────────
// No more 3D, no particles, no heavy background animations
// ────────────────────────────────────────────────
    ...
    <div className="relative min-h-screen bg-black text-gray-100 overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 py-16 md:py-24 lg:py-32">
        ...
        <div className="mt-20 md:mt-28 text-center">
          <a
            href="/contact"
            className="inline-flex items-center gap-3 px-10 md:px-14 py-5 md:py-6 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 text-white text-lg md:text-xl font-semibold rounded-2xl shadow-2xl shadow-red-900/50 transition-all hover:-translate-y-1.5 hover:shadow-red-800/60 active:scale-95"
          >
