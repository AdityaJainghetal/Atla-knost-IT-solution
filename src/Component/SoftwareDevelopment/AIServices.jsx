        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.h2
              ...
              className="text-4xl md:text-6xl font-black mb-8"
            >
              Why Choose <span className="text-red-500">Atla Knots IT Solutions</span>?
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-xl text-gray-300 mb-8"
            >
              Atla Knots IT Solutions is a trusted provider of AI & Machine Learning Services in Bhopal, focused on delivering practical and result-oriented solutions. We don’t just build technology, we build solutions that solve real business problems.
            </motion.p>
            <motion.ul variants={fadeInUp} className="space-y-4 text-lg">
              {[
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-black/70">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto"
          >
            Transform your business with smart technology. Partner with Atla Knots IT Solutions for reliable and result-driven AI & Machine Learning Services in Bhopal. Contact us today to discuss your project and take your business to the next level.
          </motion.p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.98 }}
