            ...
            {[
              {
                ...
                a: "ERP (Enterprise Resource Planning) software helps businesses manage multiple operations such as finance, HR, inventory, sales, and customer management in one centralized system. Atla Knots IT Solutions develops custom ERP solutions that automate processes, reduce manual work, and improve decision-making with real-time data.",
              },
              {
                q: "What industries can benefit from ERP software developed by Atla Knots IT Solutions?",
                a: "ERP software developed by Atla Knots IT Solutions can benefit many industries including education, healthcare, manufacturing, real estate, finance, retail, and e-commerce. Our custom ERP systems are designed according to the unique workflow and requirements of each industry.",
              },
              {
                q: "How much does custom ERP software development cost?",
                a: "The cost of ERP software development depends on features, integrations, and business requirements. A simple ERP system may cost less, while enterprise-level ERP solutions require more development time. Atla Knots IT Solutions offers flexible and transparent pricing with no hidden costs.",
              },
              {
                q: "How long does it take to develop ERP software?",
                a: "ERP development timelines depend on the project complexity and features required. Basic ERP solutions can take a few weeks, while advanced enterprise ERP systems may take several months. Atla Knots IT Solutions follows a structured development process to ensure timely delivery and high-quality results.",
              },
              {
                q: "Does Atla Knots IT Solutions provide ERP maintenance and support?",
                a: "Yes. Atla Knots IT Solutions provides ongoing ERP support, maintenance, updates, and system optimization after deployment. This ensures your ERP system remains secure, scalable, and aligned with your growing business needs.",
              },
            ].map((faq, idx) => (
              <motion.div
                key={idx}
