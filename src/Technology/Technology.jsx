...
//   fetchProducts,
//   setSelectedCategory,
// } from "./technologyslice/technologySlice";   // ← adjust path according to your folder structure
...
//   useEffect(() => {
//     // "All" → null categoryId (show all products)
//     const categoryId = selectedCategory?._id || null;
//     dispatch(fetchProducts(categoryId));
//   }, [dispatch, selectedCategory]);

//   // Scroll tracking (still local – no need to put in redux)
//   useEffect(() => {
